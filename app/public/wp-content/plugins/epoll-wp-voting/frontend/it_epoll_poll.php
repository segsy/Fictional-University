				...
				<div class="it_epoll_pull">
				  ...
				  <span class="it_epoll_survey-progress">
					<span class="it_epoll_survey-progress-bg">
					  <span class="it_epoll_survey-progress-fg it_epoll_orange_gradient" style="width:<?php echo esc_html( $it_epoll_poll_vote_percentage );?>%;"></span>
				  </span>
				  ...
				  <input type="hidden" name="it_epoll_poll_e_vote_count" id="it_epoll_poll_e_vote_count" value="<?php echo esc_html( $it_epoll_poll_vote_count );?>"/>
